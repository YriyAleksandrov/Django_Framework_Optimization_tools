...
def send_verify_link(user):
    ...
    massage = f'Your link for account activation: {settings.DOMAIN_NAME}{verify_link}'
    return send_mail(subject, massage, settings.EMAIL_HOST_USER, [user.email], fail_silently=False)
